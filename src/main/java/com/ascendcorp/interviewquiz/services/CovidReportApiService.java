...
public class CovidReportApiService implements CovidReportService {
    ...
    @Override
    public List<CovidReportData> getReports(String date) throws URISyntaxException, NoSuchElementException {
...
//        try {
        if (null == date || date.isEmpty() || date.isBlank()) {
            throw new NoSuchElementException("date cannot be null or empty");
        }
